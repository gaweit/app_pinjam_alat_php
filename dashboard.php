    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         ...
         <div class="col-md-4">
          <div class="panel panel-success">
            <div class="panel-heading">Data Barang Pertanian</div>
            <div class="panel-body">
              ...
              require 'config/koneksi.php';
                ...
                <center><a href="cetakbarang.php" class="btn btn-success">Cetak Laporan Data Barang</a></center>
            </div>
            </div>
        </div>
         ...
         <div class="col-md-4">
          <div class="panel panel-success">
            ...
            <div class="panel-body">
              ...
              <?php
              require 'config/koneksi.php';
                $query = $mysqli->query("SELECT count(id_anggota) as a FROM anggota");
                $data = mysqli_fetch_assoc($query);
                ?>
                <h2><?php echo $data['a']; ?>  Anggota</h2>
                <center><a href="cetakanggota.php" class="btn btn-success">Cetak Laporan Data Anggota</a></center>
            </div>
            </div>
        </div>
        ...
        <div class="row">
         <div class="col-md-4">
          <div class="panel panel-success">
            <div class="panel-heading">Data Jumlah Peminjam</div>
            <div class="panel-body">
              <div class="col-md-3">
              ...
              require 'config/koneksi.php';
                ...
                <center><a href="cetakpeminjaman.php" class="btn btn-success">Cetak Laporan Peminjaman</a></center>
            </div>
            </div>
        </div>
        ...
        <div class="row">
         <div class="col-md-4">
          <div class="panel panel-success">
            <div class="panel-heading">Data Jumlah Pengembalian</div>
            <div class="panel-body">
              <div class="col-md-3">
              ...
              require 'config/koneksi.php';
                ...
                <center><a href="cetak.php" class="btn btn-success">Cetak Laporan Pengembalian</a></center>
            </div>
            </div>
        </div>
