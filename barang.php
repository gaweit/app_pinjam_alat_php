    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h2 class="page-header">Data Barang</h2></center>
          <div class="row">
            <a href="tambahbrg.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Tambah</a>
          </div>
                     ...
                     while ($lihat=mysqli_fetch_array($query)){
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> <a href="editbrg.php?id_brg=<?php echo $lihat['id_brg']; ?>" class="btn btn-primary">&nbsp;&nbsp;Edit</a>
