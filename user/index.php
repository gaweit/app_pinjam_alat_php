...
<body>
    ...
    <img src="download.png" height="5%" width="5%" align="left" border=20>
    <img src="smk.jpg" height="5%" width="5%" align="right" border=20>
    <br>
    <ul class="nav navbar-nav">
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                    <li>
                        <a href="peminjamanuser.php">Lihat Data Peminjaman</a>
                    </li>
            </ul>
            <ul class="nav navbar-nav">
                    <li>
    ...
    <font color="black" face="Times new roman"><center><marquee scrollamount="10"><h4>Selamat datang di aplikasi Peminjaman
        barang pada gudang SMK Negeri 1 Pangkalan Kuras, pastikan anda merupakan orang yang bertanggung jawab
        dalam kepemilikan barang yang sudah anda pinjam<BR></marquee></font></center>
            <h2 style="text-align:center;">Daftar Alat</h2>
                    ...
                    while ($row_alat = mysqli_fetch_array($alat))
                      ...
                      ?>
                        <div class="col-md-4" style="padding: 50px">
                            ...
                            <p>Kode Barang : <?php echo $row_alat['kode_barang']; ?></p>
