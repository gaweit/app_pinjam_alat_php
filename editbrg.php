    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h1 class="page-header">Edit Barang</h1></center>
              ...
              <section class="row">
                ...
                <?php
                  ...
                  <div class ="form-group">
                    ...
                    <input type="text"  value="<?php echo$qu['kode_barang'] ?>" name="kode_barang"
                    class="form-control" placeholder="" required>
                    </div>
                    ...
                    <select name="jenis_brg" class="form-control">
                      <option value="0" <?php echo $qu['jenis_brg'] == 0 ? 'selected' : ' ' ?>>Alat Ukuran Kecil</option>
                      <option value="1" <?php echo $qu['jenis_brg'] == 1 ? 'selected' : ' ' ?>>Alat Ukuran Sedang</option>
					  <option value="2" <?php echo $qu['jenis_brg'] == 2 ? 'selected' : ' ' ?>>Alat Ukuran Besar</option>
                    </select>
                    </div>
