    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h1 class="page-header">Edit Peminjaman</h1></center>
              ...
              <section class="row">
                ...
                <?php
                  ...
                  <div class ="form-group">
                    ...
                    <input type="text" disable value="<?php echo $qu['kode_brg'] ?>" name="kode_brg" class="form-control" placeholder="" disabled>
                    <input type="hidden" value="<?= $qu['kode_brg']; ?>" name="kode_brg">
                    </div>
                   ...
                   <input type="date" value="<?php echo date('Y-m-d', strtotime($qu['tgl_pinjam'])) ?>"  name="tgl_pinjam"
                    ...
                    <div class="form-group">
                        <?php
                            ...
                            $date = date("Y / m / d");
                            $deadline = mktime(0,0,0,date("d")+2,date("m"),date("Y"));
                            $kembali = date("m / d / Y", $deadline);
                        ?>
							<label for="">Deadline Pengembalian</label>
							<input type="text" disabled name="deadline" class="datepicker form-control" value="<?php echo $kembali; ?>">
							<input type="hidden" name="deadline" class="datepicker form-control" value="<?php echo $kembali; ?>">
								</div>
                    ...
                    <div class ="form-group">
                    <label for="exampleInputPassword1">Penerima Barang</label>
                    <tr>
                                    <td> 
                                        <select name="penerima" class="form-control selectpicker">
                                        <option value="">-</option>   
                      ...
                      <tr>
                          <td>
                              Denda
                      <input type="text" class="form-control" placeholder="Masukan Jika Barang Terlambat Dikembalikan, Rusak/Hilang" value="" name="denda">
                           </td>
                      </tr>
