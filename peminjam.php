...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <center><h2 class="page-header">Data Anggota</h2></center>
     
       <a href="tambahpeminjam.php" class="btn btn-success pull-right" style="margin-bottom: 20px;"><i class="fa fa-plus"></i> Tambah</a>
