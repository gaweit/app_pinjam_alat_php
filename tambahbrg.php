    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h2 class="page-header">Tambah Barang</h2></center>
          ...
          <form role="form1" action="prosestambahbrg.php" method="post" enctype="multipart/form-data"> 
             ...
             <table>
                    ...
                    <input type="text"  name="kode_barang" class="form-control" placeholder="Kode Barang..." required>
                          ...
                          <select name="jenis_brg" class="form-control">
                            <option value="" disabled selected>- Pilih Jenis Alat Pertanian -</option>
                            <option value="Kecil"> Alat Ukuran Kecil </option>
					        		<option value="Sedang"> Alat Ukuran Sedang </option>
						        	<option value="Besar"> Alat Ukuran Besar </option>
                          </select>
                        </div>
            ...
            <tr>
            <td><button type="submit" class="btn btn-success" name="tambah">Tambah Data</button></td>
